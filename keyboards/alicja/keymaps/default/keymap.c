...
//,-----------------------------------------------------------------------------------------------------------.
   ...
   KC_LGUI,          KC_LALT, LT(1,KC_SPC), KC_BSPC, LT(1,KC_SPC),  KC_ENT, JP_ZKHK,             KC_LEFT, KC_DOWN, KC_RGHT
 ),
    [1] = LAYOUT( /* extra */
//,---------------------------------------------------------------------------------------------------------------------------.
   KC_PWR,   KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_INS, _______, KC_PWR, \
