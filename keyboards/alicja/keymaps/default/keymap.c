...
//,-----------------------------------------------------------------------------------------------------------.
   KC_ESC,   JP_1,   JP_2,    JP_3,    JP_4,    JP_5,    JP_6,    JP_7,    JP_8,    JP_9,    JP_0,    JP_MINS, JP_CIRC, JP_YEN, KC_DEL, KC_ROPT,\
   ...
   KC_LGUI,          KC_LALT, LT(LOWER,KC_SPC), KC_BSPC, LT(RAISE,KC_SPC),  KC_ENT, JP_ZKHK,          KC_LEFT, KC_DOWN, KC_RGHT
    ...
    [_LOWER] = LAYOUT( /* extra */
//,---------------------------------------------------------------------------------------------------------------------------.
   KC_PWR,   KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_INS, _______, RESET, \
