...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEFAULT] = LAYOUT(
      ...
      KC_ACT,  KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,   _______, \
    ...
    [_RAISE] = LAYOUT(
      ...
      KC_F5,   KC_F6,   KC_F7,   KC_F8,   A(KC_ENT),A(KC_UP), KC_LEFT, KC_RGHT, KC_ENT, _______, \
    ...
    [_LOWER] = LAYOUT(
      ...
      KC_LSFT, KC_NM  , JP_PLUS, JP_ASTR, JP_AT,   KC_RO,   JP_MINS, JP_SCLN, JP_COLN, _______, \
    ...
    [_NUMBER] = LAYOUT(
      ...
      KC_LCTL, XXXXXXX, JP_PLUS, JP_ASTR, JP_MINS, JP_UNDS, KC_4,    KC_5,    KC_6, _______, \
    ...
    [_CLIPSTUDIO] = LAYOUT(
      ...
      KC_ACT,     LCTL(KC_S),   LCTL(KC_D), LCTL(KC_E),  KC_G,    KC_H,       LCTL(KC_J), KC_K,       KC_L, _______, \
